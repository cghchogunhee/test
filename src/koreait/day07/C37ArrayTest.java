...
public class C37ArrayTest {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<arr2.length; i++) {	//***배열의 배열요소의 갯수(크기)를 갖고 있는 필드(특징) length 가 있습니다.
		...
		System.out.println("\n::배열의 크기(바이트)::");
		System.out.println("arr1 배열 : " + arr1.length*Integer.BYTES + "바이트");	//Integer.BYTES 값은 4, arr1.length 값은 7
		System.out.println("arr2 배열 : " + arr2.length*Integer.BYTES + "바이트");
		
		System.out.println("\n::long 배열 크기 테스트::");
		long[] larr = new long[7];
		System.out.println("larr 배열 크기(갯수) : " + larr.length);
		...
		System.out.println("arr1 : " + arr1.hashCode());	//10진수 값
		System.out.println("arr1 : " + Integer.toHexString(arr1.hashCode())); //10진수 -> 16진수
		System.out.println("arr2 : " + arr2);
		System.out.println("larr : " + larr);
		
		String message = "hello";
		System.out.println(message.hashCode());	//해시코드가 있다.
		
		int x =10;
		System.out.println(x);	//기본형 타입은 해시코드가 없다.
